public class BkashAccountWithSyncOldWay {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Final balance with synchronization: " + balance);
    }

    // Method to credit the account with a certain amount
    public static void creditAccount(int amount) {
        synchronized (lock) { // Synchronize access to prevent race conditions
