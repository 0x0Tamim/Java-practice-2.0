        ...
        try(Scanner scanner =new Scanner(menuFile)){
            ...
            while(scanner.hasNextLine()){
                ...
                if(parts[0].equalsIgnoreCase(itemName)){
                    ...
                    updatedMenu.append(oldItemName).append(",").append(newPrice).append(",").append(stock).append("\n");
                }
                else {
        ...
        try(Scanner scanner =new Scanner(menuFile)){
            ...
            while(scanner.hasNextLine()){
                ...
                if(parts[0].equalsIgnoreCase(itemName)){
                    ...
                    updatedMenu.append(oldItemName).append(",").append(price).append(",").append(newStock).append("\n");
                }
                else {
                    updatedMenu.append(line).append("\n");
                }
